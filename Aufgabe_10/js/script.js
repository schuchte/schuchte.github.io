...
var checkedDOMElement;
var uncheckedDOMElement;
/**
...
function drawListToDOM() {
    ...
    for (var index = 0; index < penguin.text.length; index++) {
        _loop_1(index);
    }
    updateCounter();
}
function updateCounter() {
    ...
    for (var i = 0; i < penguin.checked.length; i++) {
        if (penguin.checked[i] == true) {
            checked++;
        }
        else {
            penguin.checked[i] != true;
            unchecked++;
        }
    }
